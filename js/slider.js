const moviesSlider = JSON.parse(localStorage.getItem('movies')) || []
...
// render slides
const slideHtmls = moviesSlider.map((movie, index) => {
    return `
            ...
            <div class="slide">
                ...
                <div class="slide-content">
                    ...
                    <div class="slide-buttons"> 
                        ...
                        <a href="detail.html?movie_id=${movie.id}" class="slide-button more-info">
...
// Initialize dots
const dotHtmls = moviesSlider.map((_, index) => {
...
function updateDotActive(index) {
    const dots = document.querySelectorAll('.slider-dot')
    const totalSlides = moviesSlider.length
